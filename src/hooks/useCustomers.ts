...
const initialMockCustomers: Customer[] = [
    { id: '1', name: 'Alice Johnson', phone: '138-0000-0001', email: 'alice@example.com', totalSpent: 12500, lastOrderDate: '2023-10-25' },
    { id: '2', name: 'Bob Smith', phone: '139-0000-0002', email: 'bob@example.com', totalSpent: 5400, lastOrderDate: '2023-10-24' },
];
...
export function useCustomers() {
    ...
    const addCustomer = (customer: Omit<Customer, 'id' | 'totalSpent' | 'lastOrderDate'>) => {
